...
// 2. Create Sample Users with Password Hashing
// Note: In a real application, you would hash passwords using bcrypt
// For demo purposes, we're using plain text (CHANGE IN PRODUCTION!)
...
const sampleUsers = [
  {
    ...
    username: "sarahj",
    password: "$2a$10$example.hash.for.demonstration", // In production, use real bcrypt hash
  ...
  },
  {
    ...
    username: "mikec",
    password: "$2a$10$example.hash.for.demonstration",
    school: "Engineering College",
    branch: "Computer Science",
...
const sarahId = insertedUsers.insertedIds[0];
const mikeId = insertedUsers.insertedIds[1];
const emilyId = insertedUsers.insertedIds[2];
const alexId = insertedUsers.insertedIds[3];
const lisaId = insertedUsers.insertedIds[4];
...
// 6. Create Sample Follow Relationships
...
print("Subject note counts updated!");
...
print("Password: password123 (for demo - change in production!)");
print("\nEmail: mike.chen@university.edu");
print("Password: password123");

print("\n=== READY FOR TESTING ===");
print("Your Social Learning Notes Exchange is now populated with sample data!");
